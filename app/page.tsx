...
return ( <main className="min-h-screen bg-[#f7f4ef] text-zinc-950"> <Header
     user={user}
...
return ( <header className="sticky top-0 z-40 border-b border-black/10 bg-[#f7f4ef]/85 backdrop-blur-xl"> <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8"> <Link href="/" className="flex min-w-0 items-center gap-3"> <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-zinc-950 text-lg font-black text-white shadow-sm">
L </div>
...
return ( <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/45 p-0 backdrop-blur-[2px] sm:items-center sm:p-4"> <form
     onSubmit={onSubmit}
     className="w-full rounded-t-[2rem] border border-black/10 bg-white p-5 shadow-2xl sm:max-w-md sm:rounded-[2rem] sm:p-6"
   > <div className="mb-4 flex items-center justify-between"> <div> <h3 className="text-lg font-black">Send message</h3> <p className="mt-1 text-sm text-zinc-500">To {targetName}</p> </div>
...
function Footer() {
return ( <footer className="mt-10 border-t border-black/10 bg-white"> <div className="mx-auto flex w-full max-w-6xl flex-col gap-5 px-4 py-8 sm:px-6 lg:px-8"> <div className="flex items-center gap-3"> <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-zinc-950 text-sm font-black text-white">
L </div>
